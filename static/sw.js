...
// when there's no connection. It does NOT cache API responses or ticket
// data — this system needs a live connection to work correctly; the goal
// here is just a nicer "you're offline" experience, not offline ticketing.

const CACHE_NAME = 'raed-tickets-shell-v1';
const SHELL_ASSETS = [
  '/static/offline.html',
  '/static/logo.png',
  '/static/icon-192.png',
